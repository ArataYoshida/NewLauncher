...
- エンジンリリース確認状態の常時表示
- 選択中エンジンバージョンをドロップダウン上に表示
- 選択中エンジンバージョンのインストール状態、公開日、サイズ表示
- 新規プロジェクト作成
- 既存プロジェクトの登録
- プロジェクトとインストール済み Engine の確認付き削除
...
- Always show the engine release check status
- Show the selected engine version directly on the dropdown
